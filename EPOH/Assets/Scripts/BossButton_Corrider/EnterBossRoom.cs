...
public class EnterBossRoom : MonoBehaviour
{
    ...
    public void moveToBossRoom()
    {
        ...
        if (GameManager.instance != null && current_scene.name == "OfficeRoom1" && GameManager.instance.bossClearInfo[0] && interacting_object == "BossDog")
        {
        ...
        else if (GameManager.instance != null && current_scene.name == "OfficeRoom1" && GameManager.instance.bossClearInfo[1] && interacting_object == "BossPartTime")
        {
        ...
        else if (GameManager.instance != null && current_scene.name == "OfficeRoom2" && GameManager.instance.bossClearInfo[2] && interacting_object == "BossForgetMeNot")
        {
        ...
        else if (GameManager.instance != null && current_scene.name == "OfficeRoom2" && GameManager.instance.bossClearInfo[3] && interacting_object == "BossCriminal")
        {
        ...
        else if (GameManager.instance != null && current_scene.name == "OfficeRoom3" && GameManager.instance.bossClearInfo[4] && interacting_object == "BossHoa")
        {       
