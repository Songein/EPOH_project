...
public class LightSkill : MonoBehaviour, BossSkillInterface
{
   ...
   // [SerializeField] private float maxLength;
    ...
    public void RandomFive(Vector3[] spawnPositions) {
        ...
        GetDownFiveLaser(randomfirstPositions);
    }

    private void GetDownFiveLaser(List<Vector3> randomfirstPositions) {
   ...
   private IEnumerator MoveMachine(GameObject laser, Vector3 startPosition, Vector3 endPosition, float moveDuration) {
        ...
        {
            laser.transform.position = Vector3.Lerp(startPosition, endPosition, timeElapsed / moveDuration); // Lerp로 보간
