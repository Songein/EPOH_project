...
public class Stomping2 : MonoBehaviour, BossSkillInterface
{
    ...
    public IEnumerator StartStomping2()
    {
        ...
        _dog.GetComponent<Animator>().SetTrigger("Stomping2Down");
    ...
    void SpawnDog(Vector2 spawnPoint)
    {
        ...
        //두 발로 서는 애니메이션
        animator.SetTrigger("Stomping2Up");
    }

    GameObject SetRandomRock()
    {
        int value = Random.Range(0, rockPrefabs.Count);
        return rockPrefabs[value];
    }
}
